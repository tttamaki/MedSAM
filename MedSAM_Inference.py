...
def show_mask(mask, ax, random_color=False):  # noqa: FNE008
    if random_color:
...
def show_box(box, ax):  # noqa: FNE008
    x0, y0 = box[0], box[1]
...
@torch.no_grad()
def medsam_inference(medsam_model, img_embed, box_1024, H, W):  # noqa: N803
...
def main():
    ...
    # %% visualize results
    fig, ax = plt.subplots(1, 2, figsize=(10, 5))  # pylint: disable=W0612:unused-variable
    ax[0].imshow(img_3c)
